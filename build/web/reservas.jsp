                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr class="table-danger">
                                                <th scope="row"><%out.println(rut);%></th>
                                                <td><%out.println(nombre);%></td>
                                                <td><%out.println(apellido);%></td>
                                                <td><%out.println(fono);%></td>
                                ...
                                <div class="col-12">
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            %>
                                            <tr class="table-danger">
                                                <th scope="row"><%out.println(rshd.getString("numeroHabitacion"));%></th>
                                                <td><%out.println(rshd.getString("precioHabitacion"));%></td>
                                                <td><%out.println(rshd.getString("nombreTipoHabitacion"));%></td>
                                                <td><%out.println(rshd.getString("nombreTipoCama"));%></td>
                                                <td></td>
                                                <td>
