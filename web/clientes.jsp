                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-12">
                                ...
                                <!--Formulario de ingreso de un nuevo cliente-->
                                <form action="Cliente_sv" method="post" class="formulario-reserva">
                                    ...
                                    <!--Boton de guardar
                            Envia los datos a un servlet, el cual procesa la información-->
                            ...
                            <div class="col-12">
                                <div class="container">
                                    <div class="row">
                                        <div class="col-12">
                                            <h2>Cliente</h2>
                                            <!--Muestran todos los clientes generados mediante consulta a la base de datos-->
                                            <table class="table">
                                                <thead>
                                                    <tr>
                                                        <th>Id Cliente</th>
                                             ...
                                             %>
                                                            <th scope="row">
                                                                <%out.println(rs.getString("rutCliente"));%>
                                                            </th>
                                                            <td>
                                                                <%out.println(rs.getString("nombreCliente"));%>
                                                            </td>
                                                            <td>
                                                                <%out.println(rs.getString("apellidoCliente"));%>
                                                            </td>
                                                            <td>
                                                                <%out.println(rs.getString("fonoCliente"));%>
                                                            </td>
                                                            <td>
