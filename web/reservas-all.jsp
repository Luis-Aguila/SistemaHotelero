                                        ...
                                        <div class="row">
                                            <div class="col-8">
                                                ...
                                                <table class="table">
                                                    ...
                                                    <tbody>
                                                        <!--Generación de consulta a la base de datos-->
                                                        <%
                                            ...
                                            %>
                                                            <tr class="table-danger">
                                                                <th scope="row">
                                                                    <%out.println(rs.getString("idReserva"));%>
                                                                </th>
                                                                <td>
                                                                    <%out.println(rs.getString("fechaReserva"));%>
                                                                </td>
                                                                <td>
                                                                    <%out.println(rs.getString("frecepcionReserva"));%>
                                                                </td>
                                                                <td>
                                                                    <%out.println(rs.getString("diaReserva"));%>
                                                                </td>
                                                                <td>
                                                                    <%out.println(rs.getString("precioReserva"));%>
                                                                </td>
                                                                <td>
                                                                    <%out.println(rs.getString("nombreEstado"));%>
                                                                </td>
                                                                <td>
                                                                    <%out.println(rs.getString("Cliente_rutCliente"));%>
                                                                </td>
                                                                <td>
                                                                    <%out.println(rs.getString("Usuario_rutUsuario"));%>
                                                                </td>
                                                            </tr>
                                                            <%}%>
                                                    </tbody>
