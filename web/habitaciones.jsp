...
%>
                ...
                <body>
                    <!--Gestiona las diferentes tipos de habitaciones-->
                    <section class="reserva">
                        <div class="container">
                            <div class="row">
                                <div class="col-6">
                                    <!--Genera habitaciones y las almacena en la base de datos-->
                                    <div class="formulario-reserva">
                                        ...
                                        <form action="Habitacion_sv" method="post">
                                            ...
                                            <div class="form-group">
                                                <!--Consulta a la base de datos los tipos de habitaciones disponibles para asignar-->
                                        ...
                                        <%}%>
                                            ...
                                            <div class="form-group">
                                                <!--Consulta a la base de datos los diferentes tipos de camas disponibles para asignar-->
                                ...
                                <div class="col-6">
                                    <div class="container tablas">
                                        <div class="row">
                                            <!--Muestra las habitaciones generadas-->
                                            <div class="col-12 tablahg">
                                             ...
                                             %>
                                                                <th scope="row">
                                                                    <%out.println(rsh.getString("numeroHabitacion"));%>
                                                                </th>
                                                                <td>
                                                                    <%out.println(rsh.getString("precioHabitacion"));%>
                                                                </td>
                                                                <td>
                                                                    <%out.println(rsh.getString("nombreTipoHabitacion"));%>
                                                                </td>
                                                                <td>
                                                                    <%out.println(rsh.getString("nombreTipoCama"));%>
                                                                </td>
                                                                <td></td>
                                                                <td>
                                                                    <form action="Habitacion_sv" method="POST">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                %>
                                                                ...
                                                                <td>
                                                                    <%out.println(rs.getString("nombreTipoHabitacion"));%>
                                                                </td>
                                                                <td></td>
                                                                <td>
                                                                    <form action="TipoHabitacion_sv" method="POST">
                                    ...
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                %>
                                                                <th scope="row">
                                                                    <%out.println(rss.getString("idTipoCama"));%>
                                                                </th>
                                                                <td>
                                                                    <%out.println(rss.getString("nombreTipoCama"));%>
                                                                </td>
                                                                <td></td>
                                                                <td>
                                                                    <form action="TipoCama_sv" method="POST">
